            ...
            if (showEndGame)
            {
                if (win == -1) {
                   GameController.Instance.SetGameOverText("Draw at Round " + GameController.Instance.currentRound, 0);
                    ...
                    GameController.Instance.finalWinP1Score.text = GameController.Instance.p1Score.ToString();
                    GameController.Instance.finalWinP2Score.text = GameController.Instance.p2Score.ToString();
                }
                else
                {
                    if (GameController.Instance.isBotPlaying)
